        ...
        return (
          <div>
            ...
            {content.stacks.map((stack) => {
              return <ListStack>#{stack}</ListStack>;
            })}
            {content.startAt}
            <Btn>참여자 보기</Btn>
          </div>
